...
public class Num2Eng {
    ...
    static Level []levels = {
        ...
        new Level(11, "eleven"),
        new Level(12, "twelve"),
        new Level(13, "thirteen"),
        new Level(14, "fourteen"),
        new Level(15, "fifteen"),
        new Level(16, "sixteen"),
        new Level(17, "seventeen"),
        new Level(18, "eighteen"),
        new Level(19, "nineteen"),
        new Level(20, "twenty"),
        new Level(30, "thirty"),
        new Level(40, "forty"),
        new Level(50, "fifty"),
        new Level(60, "sixty"),
        new Level(70, "seventy"),
        new Level(80, "eighty"),
        new Level(90, "ninety"),
        new Level(100, "hundred", false),
        new Level(1000, "thousand", false),
